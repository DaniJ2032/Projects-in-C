...
//				if(resultado_dato == 0x03800003 ){	//Seteo de las ondas de Sen y Cos
//
////					XGpio_DiscreteWrite(&GpioOutput,1, (u32) (0x03800B03 & (0xFF7FFFFF)));		//REVISARRRRRRRRRRRRRRR
////					XGpio_DiscreteWrite(&GpioOutput,1, (u32) 0x03800B03);
////					XGpio_DiscreteWrite(&GpioOutput,1, (u32) (0x03800B03 & (0xFF7FFFFF)));
//					XGpio_DiscreteWrite(&GpioOutput,1, (u32) (0x00800000 & (0xFF7FFFFF)));
...
//
//
//					XGpio_DiscreteWrite(&GpioOutput,1, (u32) (resultado_dato & (0xFF7FFFFF)));		//REVISARRRRRRRRRRRRRRR
//					XGpio_DiscreteWrite(&GpioOutput,1, (u32) resultado_dato);
//					XGpio_DiscreteWrite(&GpioOutput,1, (u32) (resultado_dato & (0xFF7FFFFF)));
//				}
